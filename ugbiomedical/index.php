...
<script>
    ...
    fbq('init', '612387725053319');
    fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=612387725053319&ev=PageView&noscript=1"
    /></noscript>
    <!-- End Meta Pixel Code -->
  ...
  <div class="header">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-7 col-md-12 col-12">
           <h4 class="typewriter"><b>Helpline</b> : +91 701010510  &nbsp; <b>Email</b> : dracademic@sriramachandra.edu.in
           </h4>
         </div>
        </div>
      </div>
    ...
    <div class="main-banner-background">
      ...
      <div class="main-section" >
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-8 col-md-6 col-12 col-xl-7">
              <!-- <h1 class="banner_title">Welcome to Sri Ramachandra Faculty of Biomedical Sciences and Technology</h1> -->
              ...
              <div class="row align-items-center">
               <!--  <div class="col-lg-7 col-md-9 col-12">
                  <img class="main-banner-slider" src="./assets/images/bm-banner.jpg" alt="smile-list" />
                </div> -->
                ...
                <form id="addmission_form" action="#" method="POST" onSubmit="return false;" autocomplete="off" style="display: block;">
                  ...
                  <div class="form-group">
                    <select class="form-control" name="course_interest" id="course_interest" onchange='getmode(this.value)'>
                      ...
                      <option class="form-select-option" value="30">B.Sc. (Hons) Biomedical Sciences</option>
                      <option class="form-select-option" value="31">B.Sc. (Hons) Medical Biotechnology</option>
                      <option class="form-select-option" value="32">B.Sc. Medical Biotechnology</option>
                      <option class="form-select-option" value="39">B.Sc Bioinfomatics</option>
                    </select>
                  </div>
...
<div class="sretee_section">
    ...
    <div class="slide">
      <img class="banner_grade_image" src="./assets/images/1_banner.jpg" alt="slide1">
    </div>
    <div class="slide">
      <img class="banner_grade_image" src="./assets/images/2_banner.jpg" alt="slide2">
    </div>
    <div class="slide">
      <img class="banner_grade_image" src="./assets/images/3_banner.jpg" alt="slide3">
    </div>
    <div class="slide">
      <img class="banner_grade_image" src="./assets/images/4_banner.jpg" alt="slide4">
    </div>
    <div class="slide">
      <img class="banner_grade_image" src="./assets/images/5_banner.jpg" alt="slide4">
    </div>
  </div>
  </div>
</div>
  ...
  <script>
    $(document).ready(function() {
      // Update this selector from ".ranking-logos" to ".logo-sliders"
      $('.logo-sliders').slick({
        autoplay: true,
        speed: 1000,
        infinite: true,
  ...
  <div class="laboratory_section">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="laboratory_section_border" style="background-color: #084B83;">
            <div class="">
              <img class="edge_frame_content_image" src="./assets/images/programmes_icon1.png" alt="smile-list" style="    filter: brightness(0) invert(1);"/>
              <p class="edge_frame_details" style="color: white;">B.Sc. (Hons.) Biomedical Sciences</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="laboratory_section_border1" style="background-color: #084B83;">
            <div class="">
              <img class="edge_frame_content_image" src="./assets/images/programmes_icon2.png" alt="smile-list" style="    filter: brightness(0) invert(1);"/>
              <p class="edge_frame_details" style="color: white;">B.Sc. (Hons.) Medical Biotechnology</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="laboratory_section_border2" style="background-color: #084B83;">
            <div class="">
              <img class="edge_frame_content_image" src="./assets/images/programmes_icon3.png" alt="smile-list" style="    filter: brightness(0) invert(1);"/>
              <p class="edge_frame_details" style="color: white;">B.Sc. Medical Biotechnology</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="Bentley_University_section">
    <div class="container">
      <div class="row align-items-center">
      <div class="col-lg-5">
        <img src="../ugbiomedical/assets/images/eligibility.jpg" class="eligibility_image">
      </div>
      <div class="col-lg-7">
      <h2 class="programmes_title">Eligibility</h2>
      <ul class="order_style">
        <li class="list_style">
          <p class="Bentley_University_adv_details">Students who have qualified HSC/CBSE/ISC or equivalent examination with one of the following subject combinations -</p>
        </li>
      </ul>
      <ul class="order_style_tri">
        <li class="list_style_tri">
          <p class="Bentley_University_adv_details">Physics, Chemistry, Biology, Mathematics</p>
        </li>
        <li class="list_style_tri">
          <p class="Bentley_University_adv_details">Physics, Chemistry, Botany, Zoology</p>
        </li>
        <li class="list_style_tri">
          <p class="Bentley_University_adv_details">Physics, Chemistry, Biology (with any other subject)</p>
        </li>
      </ul>
      <ul class="order_style">
        <li class="list_style">
          <p class="Bentley_University_adv_details">Candidate should have completed 17 years as on 31st December of the year of admission.</p>
        </li>
      </ul>
    </div>
  </div>
...
<div class="Exploreklu" id="exploreklu" >
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div class="laboratory_section_border" style="background-color: white;">
        <div class="Explore-img">
          <div class="youtube-panel-text">
...
<script>
  ...
  <div class="programmes_section">
    <div class="container">
      <div class="text_design" style="text-align: center;">
        <h2 class="programmes_title" style="color: white;z-index: 999;position: relative;">Scope for Biomedical Graduates in Higher Education</h2>
        <!-- <img class="main_design" src="./assets/images/design.png" alt="smile-list" /> -->
      </div>
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1" style="color: white;">M.Sc. Biochemistry</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1" style="color: white;">M.Sc. Biotechnology</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1" style="color: white;">M.Sc. Radiobiology</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1" style="color: white;">M.Sc. Bioinformatics</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1" style="color: white;">M.Sc. Microbiology</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1" style="color: white;">M.Sc. Psychology</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1" style="color: white;">M.Sc. Immunology</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1" style="color: white;">M.Sc Human Genetics</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1" style="color: white;">M.Sc. Molecular Biology</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1" style="color: white;">MBA (Hospital & Health Systems Management)</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1" style="color: white;">Allied Health Science (M.Sc. Neuroscience, MLT)</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1" style="color: white;">Entry to National & International Universities</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-5 col-12">
          <div class="hallmark-excellence-right">
            ...
            <p class="hallmark-excellence-details">
              Join Sri Ramachandra Faculty of Management Sciences and become part of an elite network driving
  ...
  <div id="FAQ-Section">
      <h2 class="programmes_title">FAQ's</h2>
    <div class="accordian">
...
.edge_frame {
  position: relative;            /* To contain absolutely positioned pseudo-element */
  overflow: hidden;             /* Ensures no overflow if pseudo-element slides in from outside */
  z-index: 0;                   /* Stacking context so that the pseudo-element can sit behind */
  /* (Optional) any default background-color you want initially */
  background-color: #FFFFFF;    
}
...
.edge_frame::before {
  content: "";
  position: absolute;
  inset: 0;                     /* top:0; right:0; bottom:0; left:0; covers entire .edge_frame */
  background-color: #084B83;    /* The hover color you want to reveal */
  transform: translateX(-100%); /* Start completely “off” to the left */
  transition: transform 0.5s ease; 
  z-index: -1;                  /* Keep behind text/content of .edge_frame */
}

.edge_frame:hover::before {
  transform: translateX(0);     /* Slide in from left to right */
}
.edge_frame:hover .edge_frame_details{
color: white!important;
}
#helpdesk-snippet .right p a{
  text-decoration: none;
}

.slick-slide {
  height: auto!important; /* Ensures that the height of each slide adjusts automatically */
}

.logo-sliders {
  display: flex;
  transition: transform 1s ease-in-out; /* Smooth transition for each image */
}

.main-banner-slider {
  width: 100%;
  height: auto; /* Makes sure the images maintain their aspect ratio */
}
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  items.forEach((item1) => {
    item1.querySelector(".FAQ-title").addEventListener("click", () => {
      if (item1.classList.contains("selected")) {
        item1.classList.remove("selected");
        item1.querySelector(".FAQ-content").classList.remove("show");
      } else {
        ...
        item1.querySelector(".FAQ-content").classList.add("show");
      }
    });
  });
});
