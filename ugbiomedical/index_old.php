  ...
  <div class="sretee_section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="banner_grade">
            <img class="main-banner-slider banner_grade_image" src="./assets/images/mainlogo4.png" alt="smile-list" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="laboratory_section_border">
            <div class="">
              <img class="edge_frame_content_image" src="./assets/images/programmes_icon1.png" alt="smile-list" />
              <p class="edge_frame_details">B.Sc. (Hons.) Biomedical Sciences</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="laboratory_section_border1">
            <div class="">
              <img class="edge_frame_content_image" src="./assets/images/programmes_icon2.png" alt="smile-list" />
              <p class="edge_frame_details">B.Sc. (Hons.) Medical Biotechnology</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="laboratory_section_border2">
            <div class="">
              <img class="edge_frame_content_image" src="./assets/images/programmes_icon3.png" alt="smile-list" />
              <p class="edge_frame_details">B.Sc. Medical Biotechnology</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="programmes_section">
    <div class="container">
      <div class="text_design" style="text-align: center;">
        <h2 class="programmes_title">Scope for Biomedical Graduates in Higher Education</h2>
        <!-- <img class="main_design" src="./assets/images/design.png" alt="smile-list" /> -->
      </div>
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1">M.Sc. Biochemistry</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1">M.Sc. Biotechnology</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1">M.Sc. Radiobiology</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1">M.Sc. Bioinformatics</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1">M.Sc. Microbiology</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1">M.Sc. Psychology</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1">M.Sc. Immunology</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1">M.Sc Human Genetics</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1">M.Sc. Molecular Biology</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1">MBA (Hospital & Health Systems Management)</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1">Allied Health Science (M.Sc. Neuroscience, MLT)</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="programmes_block_border">
            <p class="edge_frame_details1">Entry to National & International Universities</p>
          </div>
        </div>
      </div>
    </div>
