            ...
            <div class="col-lg-4 col-md-6 col-12">
                  <div class="hover12">
                     <div class="image-container">
                        <a href="https://admissions.sriramachandra.edu.in/ugengineering/?utm_source=<?php echo $utm_source; ?>&utm_medium=<?php echo $utm_medium; ?>&utm_campaign=<?php echo $utm_campaign; ?>&utm_term=ugengineering&utm_content=ugengineering" target="_blank">
                           <img class="main_banner_img" src="./assets/images/postugengineering1.png" alt="">
                           <button class="center-button">Engineering Admission 2025-26</button>
                        </a>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="hover12">
                     <div class="image-container">
                        <a href="https://admissions.sriramachandra.edu.in/?utm_source=<?php echo $utm_source; ?>&utm_medium=<?php echo $utm_medium; ?>&utm_campaign=<?php echo $utm_campaign; ?>&utm_term=ug&utm_content=ug" target="_blank">
                           ...
                           <button class="center-button">UG Admission 2025-26</button>
                        </a>
                     </div>
                  </div>
               </div>
               <div class="col-md-3 mobileonly1"></div>
               <div class="col-lg-4 col-md-6 col-12">
                  <div class="hover12">
                     <div class="image-container">
                        ...
                        <a href="https://admissions.sriramachandra.edu.in/pg/?utm_source=<?php echo $utm_source; ?>&utm_medium=<?php echo $utm_medium; ?>&utm_campaign=<?php echo $utm_campaign; ?>&utm_term=pg&utm_content=pg" target="_blank">
                           ...
                           <button class="center-button">PG Admission 2025-26</button>
                        </a>
                     </div>
                  </div>
               </div>
